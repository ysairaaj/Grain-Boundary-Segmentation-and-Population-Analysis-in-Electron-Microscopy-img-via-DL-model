# -*- coding: utf-8 -*-
"""
Created on Sun Aug 22 14:49:00 2021
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        x9 = self.up4(x8, x1)
        y_out = self.outc(x9)  
        return float(20.0)*torch.sigmoid(y_out)