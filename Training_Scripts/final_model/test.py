...
from final_model import Im_Seg_3 , Im_Seg_2
...
model_path = './models/full_full_weights_15_3e-05_1.0_1.0.pt'

#Data paths
path2test="./data/_inp_/test"
path2test2="./data/_inp_2/test"
path2test3="./data/_inp_3/test"
...
test_ds=open_dataset(path2test, path2test2 , path2test3, transform='test')   
