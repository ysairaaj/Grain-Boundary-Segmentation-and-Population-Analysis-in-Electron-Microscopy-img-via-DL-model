...
from final_model import Im_Seg_2 ,Im_Seg_4
...
parser.add_argument('--malis_pos', action='store', default = 0.1, help='Positive Malis parameter')
...
params_train={
    ...
    "test_dl": test_dl,
    "sanity_check": False,
    "path2weights": path2models+"full_full_weights_{}_{}_{}_{}.pt".format(n_epoch, lr, malis_neg, malis_pos),
    "path2losshist": path2models+"full_loss_history_{}_{}_{}_{}.json".format(n_epoch, lr, malis_neg, malis_pos),
